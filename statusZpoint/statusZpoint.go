...
// StatusZpoint verifica allineamento accesspoin router.
func StatusZpoint(ctx context.Context, token, cli string) (err error) {
	...
	req, err := http.NewRequest("GET", urlstatusZpoint+address, nil)
	if err != nil {
